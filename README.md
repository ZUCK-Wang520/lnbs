...
- **禁止**：用于商业目的或获取商业利益  
- 分发与修改须保留许可证与版权声明  
- **本 GitHub 仓库**：仅版权所有者可推送与合并更改，**不接受**外部 PR  
...
- 禁止他人直接向本仓库提交、推送或合并任何更改  
- **不接受** Pull Request；请勿向本仓库发起修改请求  
- 他人可在许可证允许范围内自行学习与使用，但不得改动本仓库中的文件  
- 问题反馈可通过 GitHub Issues 留言（不保证答复或采纳）
